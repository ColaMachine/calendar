...
public class HBaseKerbrosDemo {
	...
	static {
		...
		conf.set("kerberos.principal", HbaseConstants.userName);
		...
		conf.set("hbase.zookeeper.quorum", HbaseConstants.hbaseIp);
		conf.set("hbase.zookeeper.property.clientPort", HbaseConstants.port);
		conf.set("hbase.security.authentication", "kerberos");

		UserGroupInformation.setConfiguration(conf);
		try {
			UserGroupInformation.loginUserFromKeytab(HbaseConstants.userName,HbaseConstants.krb5PATH);
		} catch (IOException e) {
