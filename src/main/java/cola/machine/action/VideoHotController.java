...
@Controller
@RequestMapping("/videoHot")
public class VideoHotController extends BaseController{
    /** 日志 **/
    ...
    public String list() {
        return "/static/html/VideoHotList.html";
    }
    ...
    */
    ...
    public Object save(HttpServletRequest request) throws Exception {
        ...
        String vname = request.getParameter("vname");
        if(!StringUtil.isBlank(vname)){
            videoHot.setVname(String.valueOf(vname)) ;
        }
        
        String zbname = request.getParameter("zbname");
        if(!StringUtil.isBlank(zbname)){
            videoHot.setZbname(String.valueOf(zbname)) ;
        }
        ...
        String url = request.getParameter("url");
        if(!StringUtil.isBlank(url)){
            videoHot.setUrl(String.valueOf(url)) ;
        }
        */
        String id = request.getParameter("id");
        if(!StringUtil.isBlank(id)){
    ...
    public Object exportExcel(HttpServletRequest request){
        ...
        // 查询list集合
        List<VideoHot> list =videoHotService.listByParams(params);
        // 存放临时文件
