...
import cola.machine.service.SysUserPermissionService;
...
public class SysUserPermissionController extends BaseController{
    ...
    public String list() {
        return "/static/html/SysUserPermissionList.html";
    }

    @RequestMapping(value = "/listMapper.htm", method = RequestMethod.GET)
    public String listMapper() {
        return "/static/html/SysUserPermissionListMapper.html";
    }
    ...
    public Object list(HttpServletRequest request) {
        ...
        List<SysUserPermission> sysUserPermissions = sysUserPermissionService.listByParams4Page(params);
        return ResultUtil.getResult(sysUserPermissions, page);
    }
    ...
    */
    ...
    public Object listAll(HttpServletRequest request) {
        ...
        List<SysUserPermission> sysUserPermissions = sysUserPermissionService.listByParams(params);
        return ResultUtil.getResult(sysUserPermissions);
    }
    ...
    public Object edit( HttpServletRequest request) {
        // 查找所有的角色
        return "/static/html/SysUserPermissionEdit.html";
    }
    @RequestMapping(value = "/view.htm")
    public Object viewPage( HttpServletRequest request) {
        return "/static/html/SysUserPermissionView.html";
    }
    ...
    public Object view(HttpServletRequest request) {
        ...
        if(!StringUtil.isBlank(id)){
            SysUserPermission bean = sysUserPermissionService.selectByPrimaryKey(Long.valueOf(id));
    ...
    public Object save(HttpServletRequest request) throws Exception {
        ...
        String id = request.getParameter("id");
        if(!StringUtil.isBlank(id)){
            sysUserPermission.setId(Long.valueOf(id)) ;
        }
        
        String uid = request.getParameter("uid");
        if(!StringUtil.isBlank(uid)){
            sysUserPermission.setUid(Long.valueOf(uid)) ;
        }
        ...
        */
        ...
        vu.add("pid", pid, "权限id",  new Rule[]{new Digits(10,0),new NotEmpty()});
        validStr = vu.validateString();
        if(StringUtil.isNotEmpty(validStr)) {
            return ResultUtil.getResult(302,validStr);
        }

          return sysUserPermissionService.save(sysUserPermission);
    ...
    public Object msave(HttpServletRequest request) throws Exception {
        ...
        return sysUserPermissionService.msave( uids, pids);
    }
    ...
    public Object delete(HttpServletRequest request) {
        ...
        sysUserPermissionService.delete(id);
