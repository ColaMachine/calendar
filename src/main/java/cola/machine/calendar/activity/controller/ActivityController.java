package cola.machine.calendar.activity.controller;
...
import cola.machine.core.action.BaseAction;
import cola.machine.core.action.ResultDTO;
...
public class ActivityController extends BaseAction {
	 ...
	 */
	@RequestMapping(value = "/saveActivitys", method = RequestMethod.POST)
