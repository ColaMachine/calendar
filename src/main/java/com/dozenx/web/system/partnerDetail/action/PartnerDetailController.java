...
package com.dozenx.web.system.partnerDetail.action;
import java.io.File;
...
import com.dozenx.web.system.partnerDetail.service.PartnerDetailService;
...
public class PartnerDetailController extends BaseController{
    ...
    */
    ...
    public Object listAll(HttpServletRequest request) {
        ...
        return ResultUtil.getDataResult(partnerDetails);
    }
