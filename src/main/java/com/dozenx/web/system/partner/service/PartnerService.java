...
package com.dozenx.web.system.partner.service;
...
import com.dozenx.web.system.partner.dao.PartnerMapper;
...
public class PartnerService extends BaseService {
    ...
    public ResultDTO save(Partner partner) {
      ...
      /* ValidateUtil<Partner> vu = new ValidateUtil<Partner>();
       ...
       //判断是更新还是插入
        if (partner.getId()==null ||  this.selectByPrimaryKey(partner.getId())==null) {
