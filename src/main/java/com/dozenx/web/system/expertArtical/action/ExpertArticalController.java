...
package com.dozenx.web.system.expertArtical.action;
...
import com.dozenx.web.system.expertArtical.service.ExpertArticalService;
...
public class ExpertArticalController extends BaseController{
    ...
    */
    ...
    public Object listAll(HttpServletRequest request) {
        ...
        return ResultUtil.getDataResult(expertArticals);
    }
