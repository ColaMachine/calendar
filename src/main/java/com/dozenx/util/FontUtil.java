...
public class FontUtil {
    ...
    public static void drawAllCharacterInOneJpg(java.util.List<Character> list){
        float fontSize =24;
        int color =0x000000;
        int count =list.size();
        String out = new File("").getAbsolutePath();
    ...
    public static void generateCN(){
        try {
            ...
            java.util.List<String> lists = FileUtil.readFile2List("/Users/luying/Documents/workspace/calendar/gbk2unicode");
            int count =0 ;
    ...
    public static void generateCN2500(){
        try {
            ...
            java.util.List<String> lists = FileUtil.readFile2List("/Users/luying/Documents/workspace/calendar/normalcn");
            int count =0 ;
            for (String line : lists) {
                if (!StringUtil.isBlank(line)) {
                    String[] ary = line.split(" ");
    ...
    public static HashMap<Character,Glyph> readGlyph(){
        ...
        try {
            List<String> lines= FileUtils.readLines(new File("cn.txt","utf-8"));
