 ...
 * Created by Arvin-Mort on 16/5/3.
 */
public class GPSUtil {
    ...
    /**
     * 1.WGS84 to 火星坐标系 (GCJ-02) World Geodetic System ==> Mars Geodetic System
     *
     * @param lat
     * @param lon
     * @return
    ...
    /**
     * *2. 火星坐标系 (GCJ-02) to WGS84 * * @param lon * @param lat * @return
     * */
    ...
    /**
     * 3.火星坐标系 (GCJ-02) 与百度坐标系 (BD-09) 的转换算法 将 GCJ-02 坐标转换成 BD-09 坐标
     *
     * @param lat
     * @param lon
     */
    ...
    /**
     * * 4.火星坐标系 (GCJ-02) 与百度坐标系 (BD-09) 的转换算法 * * 将 BD-09 坐标转换成GCJ-02 坐标 * * @param
    ...
    public static double[] bd09_To_wgs84(double lat,double lon){
        ...
        double[] wgs84 = gcj02_To_wgs84(gcj02[0], gcj02[1]);
        //保留小数点后六位
