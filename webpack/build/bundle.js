...
var menuList = [{ id: 30, name: "导航条", url: "../../../static/html/example/head.html", icon: "fa fa-spinner", pid: 0 }, { id: 1, name: "layout", url: "", icon: "fa fa-spinner", pid: 0 }, { id: 101, name: "grid", url: "#grid", icon: "fa fa-spinner", pid: 1 }, { id: 101, name: "layout", url: "#layout", icon: "fa fa-spinner", pid: 1 }, { id: 2, name: "api列表", url: "#api", icon: "fa fa-area-chart", pid: 0 }, { id: 3, name: "data display", url: "", icon: "fa fa-area-chart", pid: 0 }, { id: 32, name: "collapse", url: "#collapse", icon: "fa fa-area-chart", pid: 3 }, { id: 31, name: "按钮", url: "#button", icon: "fa fa-bar-chart", pid: 0 }, { id: 32, name: "输入框", url: "../../../static/html/example/input.html", icon: "fa fa-area-chart", pid: 0 }, { id: 33, name: "图片", url: "../../../static/html/example/image.html", icon: "fa fa-area-chart", pid: 0 }, { id: 33, name: "panel", url: "../../../static/html/example/panel.html", icon: "fa fa-area-chart", pid: 0 }, { id: 34, name: "菜单", url: "../../../static/html/example/menu.html", icon: "fa fa-area-chart", pid: 0 }, { id: 34, name: "像素画板", url: "../../../static/html/example/pixelPaint.html", icon: "fa fa-area-chart", pid: 0 }];

_menu2.default.init("menu", menuList, { id: "id", url: "url", pid: "pid", name: "name" });

__webpack_require__(22);

console.log((0, _marked2.default)("##image useing markdown "), { sanitize: true });
window.onload = function () {
      /*document.getElementById('main').innerHTML =
            marked("var a={'a':1,'b':2}# Marked in browser\n\nRendered by **marked**.");*/

      var rendererMD = new _marked2.default.Renderer();
...
exports.default = {
    ...
    methods: {
        diabledForAWhile: function diabledForAWhile() {
            console.log("click");var that = this;
...
var _zwCollapse = __webpack_require__(8);

var _zwCollapse2 = _interopRequireDefault(_zwCollapse);

var _zwPanel = __webpack_require__(9);

var _zwPanel2 = _interopRequireDefault(_zwPanel);

var _apiUrl = __webpack_require__(89);
...
var _apiParameter = __webpack_require__(87);
...
exports.default = {
	name: 'apiUrl',
	components: { apiParameter: _apiParameter2.default, zwButton: _zwButton2.default },
	props: ['title', "content", "url", "formId"],
	data: function data() {
		return {
			showResponse: false,
			show: false,
...
var _apiPath = __webpack_require__(88);
...
exports.default = {
    ...
    methods: {
        getApiData: function getApiData() {
            var url = PATH + "api";
            var that = this;
            Ajax.getJSON(this.apiUrlStr, null, function (data) {
                var tags = {};
                for (var url in data.paths) {
                    console.log(url);
                    var postGetData = data.paths[url];
...
var _zwButtonGroup = __webpack_require__(86);
...
var _zwDropDown = __webpack_require__(94);

var _zwDropDown2 = _interopRequireDefault(_zwDropDown);

var _zwMenu = __webpack_require__(95);

var _zwMenu2 = _interopRequireDefault(_zwMenu);

var _zwMenuItem = __webpack_require__(96);
...
exports.default = {
    components: { aButton: _button2.default },
    data: function data() {
...
var routes = [{ path: '/button', component: _buttonExample2.default }, { path: '/layout', component: _layoutExample2.default }, { path: '/grid', component: _gridExample2.default }, { path: '/api', component: _apiExample2.default }, { path: '/collapse', component: _collapseExample2.default }];
// 接着创建路由实例
//
//
//
...
// module
exports.push([module.i, "@charset \"UTF-8\";\n@CHARSET \"UTF-8\";\n@CHARSET \"UTF-8\";\n/*color*/\n/**font-size**/\nbody {\n  font-size: 14px;\n  background-color: #fff;\n  font-family: \"Helvetica Neue\", \"Hiragino Sans GB\", \"Microsoft YaHei\", \"\\9ED1\\4F53\", Helvetica, Arial, sans-serif; }\n\n.bg-blue {\n  background-color: #00a0e9; }\n\n.clearfix:after {\n  visibility: hidden;\n  display: block;\n  font-size: 0;\n  content: \" \";\n  clear: both;\n  height: 0; }\n\n.page {\n  margin-left: 50px;\n  margin-right: 50px;\n  margin-top: 100px;\n  background-color: #fff;\n  border: 1px solid #e5e5e5; }\n\n.body-wrapper {\n  padding-top: 0px; }\n\n.main-wrap {\n  display: table-cell;\n  /*width:80%;*/\n  min-width: 800px;\n  /*margin-left: 0px;*/ }\n\n/**Position**/\n/**Box-model**/\n/**Typography**/\n/**Visual**/\n/* misc */\n.menu-wrap ul, .menu-wrap, .menu-wrap a {\n  color: #000;\n  background-color: #fff; }\n\n.menu-wrap {\n  z-index: 2000;\n  /**Position**/\n  /*position: fixed !important;*/\n  /**Box-model**/\n  display: table-cell;\n  margin: 0px 0px 0px 0px;\n  padding: 0px 0px 0px 0px;\n  border-right: 1px solid #e7e7eb;\n  width: 200px;\n  min-width: 200px;\n  height: 100%;\n  /**Typography**/\n  font-size: 18px;\n  text-align: left; }\n  .menu-wrap .logo {\n    display: none;\n    min-height: 38px;\n    margin: 0px 0px 0px 0px;\n    padding: 15px 0px 0px 0px;\n    top: 0px; }\n    .menu-wrap .logo .nav-icon {\n      color: #e5e5e5; }\n  .menu-wrap .logo-desc {\n    white-space: nowrap;\n    overflow: hidden;\n    min-height: 2.25em;\n    font-size: 1.25em; }\n  .menu-wrap li {\n    list-style: none; }\n  .menu-wrap .menu {\n    margin: 0px 0px 0px 0px;\n    padding: 15px 0px 0px 0px; }\n    .menu-wrap .menu ul {\n      margin: 0px 0px 0px 0px;\n      padding: 0px 0px 0px 0px; }\n      .menu-wrap .menu ul li.open > a > .nav-caret > i {\n        -webkit-transform: rotate(180deg);\n        -ms-transform: rotate(180deg);\n        transform: rotate(180deg); }\n      .menu-wrap .menu ul li a {\n        display: block;\n        width: 100%;\n        position: relative;\n        line-height: 2.25em;\n        min-height: 2.25em;\n        /*color: white;*/\n        text-decoration: none; }\n        .menu-wrap .menu ul li a :hover {\n          text-decoration: none;\n          background-color: #light-gray; }\n        .menu-wrap .menu ul li a .fa-caret-down {\n          font-size: 12px;\n          position: absolute;\n          top: 50%;\n          margin-top: -7px;\n          right: 11px; }\n        .menu-wrap .menu ul li a .nav-text {\n          white-space: nowrap;\n          overflow: hidden;\n          margin-left: 15px; }\n        .menu-wrap .menu ul li a .nav-caret i {\n          transition: -webkit-transform 0.3s ease-in-out 0s;\n          transition: transform 0.3s ease-in-out 0s;\n          transition: transform 0.3s ease-in-out 0s, -webkit-transform 0.3s ease-in-out 0s; }\n        .menu-wrap .menu ul li a .nav-icon {\n          margin-left: 15px;\n          color: #8d8d8d; }\n  .menu-wrap .menu > ul > li {\n    position: relative;\n    border-bottom: 1px solid #e7e7eb; }\n  .menu-wrap .nav:hover,\n  .menu-wrap .nav > li:hover,\n  .menu-wrap .nav > li > a:hover,\n  .menu-wrap .nav a:hover,\n  .menu-wrap .nav:focus,\n  .menu-wrap .nav > li:focus,\n  .menu-wrap .nav > li > a:focus {\n    /* background-color:#f4f5f9;;*/ }\n  .menu-wrap .nav a.active {\n    /*background-color: rgba(0, 0, 0, 0.077);*/\n    background-color: #44b549; }\n  .menu-wrap .nav.open > a,\n  .menu-wrap .nav.open > a:focus,\n  .menu-wrap .nav.open > a:hover {\n    background-color: #fff;\n    /*border-color: rgba(0, 0, 0, 0.077);*/ }\n  .menu-wrap .nav li a {\n    padding: 0px 0px; }\n\ni.undefined {\n  display: inline-block;\n  min-width: 18px; }\n\n/**icon style***/\n.menu-wrap .menu > ul > li > ul > li .nav-icon {\n  visibility: hidden; }\n\n/** li ul**/\n.menu-wrap .menu > ul li > ul {\n  transition: -webkit-transform 3s ease-in-out 0s;\n  transition: transform 3s ease-in-out 0s;\n  transition: transform 3s ease-in-out 0s, -webkit-transform 3s ease-in-out 0s;\n  display: none; }\n\n.menu-wrap .mark {\n  border: 1px solid red; }\n\n.menu-wrap .menu > ul li.open > ul {\n  display: block; }\n\n.menu-wrap .select span {\n  margin-right: 0px; }\n", ""]);
...
Component.options.__file = "C:\\zzw\\calendar\\webpack\\app\\component\\button\\button.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6a56c0ef", Component.options)
  } else {
    hotAPI.reload("data-v-6a56c0ef", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Component.options.__file = "C:\\zzw\\calendar\\webpack\\app\\component\\menu\\zwDropDown.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-70ee0bfe", Component.options)
  } else {
    hotAPI.reload("data-v-70ee0bfe", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Component.options.__file = "C:\\zzw\\calendar\\webpack\\app\\component\\menu\\zwMenu.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-255944ac", Component.options)
  } else {
    hotAPI.reload("data-v-255944ac", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Component.options.__file = "C:\\zzw\\calendar\\webpack\\app\\component\\menu\\zwMenuItem.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-08bc385f", Component.options)
  } else {
    hotAPI.reload("data-v-08bc385f", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-08bc385f", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('ul', {
    staticClass: "dropdown-menu  fnt-1  color-black "
  }, [_vm._t("default")], 2)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-255944ac", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("请求api文档")])], 1), _vm._v(" "), _c('zwContent', [_c('ul', {
    staticClass: "row  ",
    attrs: {
      "id": "apiList"
    }
  ...
  }))]), _vm._v(" "), _c('zwFooter', [_vm._v("Footer")])], 1)], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6a56c0ef", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('header', {
    staticClass: " bg-black color-white clearfix fnt-1   navbar"
  }, [_c('a', {
    staticStyle: {
      "cursor": "pointer"
    },
    ...
    staticClass: "  col-1 left   nav navbar-nav height3",
    attrs: {
      "id": "loginBtn"
    }
  }, [_c('img', {
    ...
    attrs: {
      "src": "http://msp-img.51awifi.com/V1/img/header/wifi.png"
    }
  }), _vm._v(" "), _c('span', {
    ...
    staticClass: "heaer-center center-text col-8 left  height3",
    attrs: {
      "id": "merchantname"
    }
  }, [_c('div', {
    staticClass: " left col-1"
  }, [_vm._v("fix-top能保证浮动")])]), _vm._v(" "), _c('a', {
    attrs: {
      "href": "#/userCenter",
      "id": "userCenter"
    }
  }, [_c('div', {
    staticClass: "  col-1 left  height3"
  }, [_c('img', {
    staticClass: "header-right-img right",
    attrs: {
      "src": "http://msp-img.51awifi.com/V1/img/header/information.png"
    }
  })])])])
}]}
module.exports.render._withStripped = true
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-70ee0bfe", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v(_vm._s(_vm.content.summary))])])]), _vm._v(" "), (_vm.show) ? _c('form', {
  ...
  }, [_c('span', [_vm._v("备注")]), _vm._v(" "), _c('span', [_c('span', {}, [_vm._v(_vm._s(_vm.content.description))])]), _vm._v(" "), _c('table', {
    staticClass: "api-list table"
  }, [_vm._m(0), _vm._v(" "), _vm._l((_vm.content.parameters), function(item) {
  ...
  }, [_vm._v("隐藏")]), _vm._v("  \n\n                          ")], 1)]), _vm._v(" "), (_vm.showResponse) ? _c('div', [_c('div', {
    staticClass: "panel-body"
  }, [_c('div', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('zwCollapse', [_c('zwPanel', [_c('span', {
    attrs: {
      "name": "title"
    },
    slot: "title"
